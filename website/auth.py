...
def sign_up():
    if request.method=="POST":
        ...
        if email_exists:
            ...
            new_user = User(image=image.read(),mimetype_profile=mimetype_profile,name=filename,email=email,username=username,is_creater=is_creator,password=generate_password_hash(password1,method="pbkdf2:sha256"))
    ...
    if request.method=="POST":
        ...
        #.........sign-up portion............
            ...
            if Admin_password != predefine_password :
                ...
                new_admin = User(image=image.read(),mimetype_profile=mimetype_profile,name=filename,email=email,username=username,password=generate_password_hash(password,method="pbkdf2:sha256"),is_admin=True)
